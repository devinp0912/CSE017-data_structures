...
public class ArrayList<E>{
    ...
    */
    ...
    public ListIterator<E> listIterator(int index){
        ListIterator<E> listIter = new BiDirectionalListIterator();
        if(index > size){
            throw new ArrayIndexOutOfBoundsException();
        }
    ...
    public class BiDirectionalListIterator implements ListIterator<E>{
        // data member: reference to the node referenced by the iterator 
        private int current = 0; 
        /**
            check if the iterator has a next element
            @return true if the iterator has access to the next element, false otherwise
            time complexity: O(1)
         */
        public boolean hasNext() {
			return current < size;
        ...
        /**
            get the value of the current element and move the iterator to the next element
        ...
        /**
            check if the iterator has a previous element
            @return true if the iterator has access to the previous element, false otherwise
            time complexity: O(1)
         */
        ...
        /**
            get the value of the current element and move the iterator to the previous element
            @return the value of the current element
            time complexity: O(1)
         */
        public E previous(){
